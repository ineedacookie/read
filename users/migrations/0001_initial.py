    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_initial', models.CharField(blank=True, max_length=1, null=True, verbose_name='Last Initial')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateField(auto_now=True, null=True, verbose_name='Updated Date')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('students', models.ManyToManyField(limit_choices_to={'user_type': 'student'}, related_name='students_classrooms', to=settings.AUTH_USER_MODEL)),
                ('teachers', models.ManyToManyField(blank=True, limit_choices_to={'user_type': 'teacher'}, related_name='teachers_classrooms', to=settings.AUTH_USER_MODEL)),
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.school')),
            ],
        ),
        migrations.CreateModel(
